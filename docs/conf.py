# -*- coding: utf-8 -*-
#
# pytest-settings documentation build configuration file, created by
...
project = u'pytest-settings'
copyright = u'2015, Kenny Valdivia'
author = u'Kenny Valdivia'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-settings Documentation',
     [author], 1)
]
